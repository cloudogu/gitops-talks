...
# Other interesting options  --monitoring --vault=dev --mailhog
```
...
* reject other PRs for less distraction

```shell
git clone http://scmm.localhost/scm/repo/argocd/petclinic-plain
cd petclinic-plain
...
## Example 1: GOP <!-- .element style="margin-top: 0px"-->
<!-- .slide: id="ex1"  -->
...
<svg width="94%"
  ...
  <g><-- class="fragment" data-fragment-index="99" -->
      ...
      <a href="http://argocd.localhost/applications?showFavorites=false&proj=example-apps&sync=&autoSync=&health=&namespace=&cluster=&labels=&search=plain"><image x="284.5" y="424.5" width="54.84" height="68"
...
<a href="http://scmm.localhost/scm/repo/argocd/petclinic-plain/code/sources/main/">
<image
     x="352.5"
     y="312.5"
     width="230"
...
<image 
  ...
  <g
    ...
    <a href="http://jenkins.localhost/job/example-apps/job/petclinic-plain/job/main/"><image
       x="583.5"
       y="260.5"
       width="33.599998"
       height="46.389999"
