// https://raw.githubusercontent.com/btemperli/reveal.js-tagcloud-plugin/master/tagcloud/tagcloud.js 
...
const initTagCloud = function (Reveal){
    [].forEach.call( document.querySelectorAll('tagcloud'), function(cloud) {
        ...
        var isSameSize = cloud.hasAttribute('samesize');
        ...
        function calcSize(elem) {
            ...
            // All cloud items should have the same size
            if (isSameSize) {
                prctnge = 0.5 * 150 + 50;
            }
            ...
            // The cloud items should be bigger
